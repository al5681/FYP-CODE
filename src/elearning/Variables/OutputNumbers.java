...
public class OutputNumbers extends LessonSuperClass {
    ...
    protected void setUp() {
        ...
        description.getChildren().add(new Text("Task 2: Manipulating data in variables\n\n" +
                "Try creating two variables, one called ‘a’ which stores the value 4 and one called ‘b’ which stores the value 5.\n\n" +
                "Then create an output node that prints the results of adding those two variables.”\n\n" +
                "Your chart should look like this:\n"));
        ImageView imageDemo = new ImageView("VLesson2.png");
