...
public class HelloWorldLessonPrototype extends LessonSuperClass {
    ...
    protected void setUp() {
        ...
        description.getChildren().add(new Text("Task 1: Hello World\n\n" +
                "The most basic element of programming allows us to print out text to the screen for the user to see.\n\n" +
                "Try adding an Output node to the chart and setting its content to “Hello World”\n\n" +
                "Your chart should look like this:\n"));
        ImageView imageDemo = new ImageView("Lesson1example.png");
