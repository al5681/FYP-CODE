...
/**
 * Controller for node selection when inserting nodes, without Else and Else If nodes as an option
 */
public class InsertNodeSelectionNoElse {
    ...
    public InsertNodeSelectionNoElse(){
        // Create the new stage
        thisStage = new Stage();

        // Load the FXML file
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("insertNodeViewNoElse.fxml"));
